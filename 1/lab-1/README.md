...
- Считать MinHash одновременно с генерацией шинглов — -50% памяти
Сейчас отдельным проходом считается шинглы Set<Long>, а потом по этому множеству считается minHash.
