...
После blockSize=128 для vbyte/bitpack/vbyte VarByte-компоненты начинают давать чуть худшую плотность: крупный блок реже выигрывает на служебных данных, но чаще содержит более длинные gap-ы, которые требуют больше байтов.
